...
SELECT Id, GenusCross, Genus, SpeciesCross, Species, Variety, Common, SKU, [Desc], PotSize, ColourQueue, Barcode, Picture1, Picture2, Picture3, Picture4, AGM, LabelColour, Hide, notes, LabelStock FROM TablePlants WHERE (Id = SCOPE_IDENTITY()) ORDER BY Genus, Species, Variety";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT AGM, Barcode, ColourQueue, Common, [Desc], Genus, GenusCross, Hide, Id, La" +
                "belColour, LabelStock, Picture1, Picture2, Picture3, Picture4, PotSize, SKU, Spe" +
                "cies, SpeciesCross, Variety, notes FROM TablePlants";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = @"SELECT        Id, GenusCross, Genus, SpeciesCross, Species, Variety, Common, SKU, [Desc], PotSize, ColourQueue, Barcode, Picture1, Picture2, Picture3, Picture4, AGM, LabelColour, Hide, notes, LabelStock
FROM            TablePlants
WHERE        (Genus LIKE '%' + @Search + '%') OR
                         (Species LIKE '%' + @Search + '%') OR
                         (Variety LIKE '%' + @Search + '%') OR
                         (Common LIKE '%' + @Search + '%')
ORDER BY Genus, Species, Variety";
        ...
        public virtual int FillBy(DatabaseLabelsDataSet.TablePlantsDataTable dataTable) {
