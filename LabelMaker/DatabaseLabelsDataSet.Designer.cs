...
SELECT Id, GenusCross, Genus, SpeciesCross, Species, Variety, Common, SKU, [Desc], PotSize, ColourQueue, Barcode, Picture1, Picture2, Picture3, Picture4, AGM, LabelColour, Hide, notes, LabelStock FROM TablePlants WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TablePlants] SET [GenusCross] = @GenusCross, [Genus] = @Genus, [Spe" +
                ...
                "elStock FROM TablePlants WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, GenusCross, Genus, SpeciesCross, Species, Variety, Common, SKU, [Desc]" +
                ", PotSize, ColourQueue, Barcode, Picture1, Picture2, Picture3, Picture4, AGM, La" +
                "belColour, Hide, notes, LabelStock FROM dbo.TablePlants";
