...
SELECT Id, GenusCross, Genus, SpeciesCross, Species, Variety, Common, SKU, [Desc], PotSize, ColourQueue, Barcode, Picture1, Picture2, Picture3, Picture4, AGM, LabelColour, Hide, notes, LabelStock FROM TablePlants WHERE (Id = SCOPE_IDENTITY()) ORDER BY Genus, Species, Variety";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = @"SELECT AGM, Barcode, ColourQueue, Common, [Desc], Genus, GenusCross, Hide, Id, LabelColour, LabelStock, Picture1, Picture2, Picture3, Picture4, PotSize, SKU, Species, SpeciesCross, Variety, notes FROM TablePlants WHERE (Hide = @name) ORDER BY Genus, Species, Variety";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@name", global::System.Data.SqlDbType.Bit, 1, global::System.Data.ParameterDirection.Input, 0, 0, "Hide", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = @"SELECT AGM, Barcode, ColourQueue, Common, [Desc], Genus, GenusCross, Hide, Id, LabelColour, LabelStock, Picture1, Picture2, Picture3, Picture4, PotSize, SKU, Species, SpeciesCross, Variety, notes FROM TablePlants WHERE (Genus LIKE '%' + @Search + '%') OR (Species LIKE '%' + @Search + '%') OR (Variety LIKE '%' + @Search + '%') OR (Common LIKE '%' + @Search + '%') ORDER BY Genus, Species, Variety";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Search", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Genus", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillBy(DatabaseLabelsDataSet.TablePlantsDataTable dataTable, bool name) {
        ...
        public virtual DatabaseLabelsDataSet.TablePlantsDataTable GetDataBy(bool name) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((bool)(name));
            DatabaseLabelsDataSet.TablePlantsDataTable dataTable = new DatabaseLabelsDataSet.TablePlantsDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBySearch(DatabaseLabelsDataSet.TablePlantsDataTable dataTable, string Search) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DatabaseLabelsDataSet.TablePlantsDataTable GetDataBySearch(string Search) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((Search == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
