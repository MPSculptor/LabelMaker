...
namespace LabelMaker.DatabaseLabelsDataSet1TableAdapters {
    ...
    public partial class TableProfilesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [TableProfiles] ([Id], [Name], [BorderColour], [FontName], [Bold], [Italic], [FontColour], [BackgroundColour]) VALUES (@Id, @Name, @BorderColour, @FontName, @Bold, @Italic, @FontColour, @BackgroundColour);
SELECT Id, Name, BorderColour, FontName, Bold, Italic, FontColour, BackgroundColour FROM TableProfiles WHERE (Id = @Id) ORDER BY Name";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [TableProfiles] SET [Id] = @Id, [Name] = @Name, [BorderColour] = @BorderColour, [FontName] = @FontName, [Bold] = @Bold, [Italic] = @Italic, [FontColour] = @FontColour, [BackgroundColour] = @BackgroundColour WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([BorderColour] = @Original_BorderColour) AND ([FontName] = @Original_FontName) AND ([Bold] = @Original_Bold) AND ([Italic] = @Original_Italic) AND ([FontColour] = @Original_FontColour) AND ([BackgroundColour] = @Original_BackgroundColour));
SELECT Id, Name, BorderColour, FontName, Bold, Italic, FontColour, BackgroundColour FROM TableProfiles WHERE (Id = @Id) ORDER BY Name";
        ...
        public virtual int Fill(DatabaseLabelsDataSet1.TableProfilesDataTable dataTable) {
        ...
        public virtual DatabaseLabelsDataSet1.TableProfilesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseLabelsDataSet1.TableProfilesDataTable dataTable = new DatabaseLabelsDataSet1.TableProfilesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseLabelsDataSet1.TableProfilesDataTable dataTable) {
