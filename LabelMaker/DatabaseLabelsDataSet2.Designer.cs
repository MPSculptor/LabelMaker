...
SELECT Id, Name, Type, LabelsAcross, LabelsDown, Orientation, Width, Height, MarginTop, MarginBottom, MarginLeft, MarginRight, DefaultPrinter, PaperSize, Flip, Rotate FROM LabelsLabelCategories WHERE (Id = SCOPE_IDENTITY())";
        ...
        public virtual int Fill(DatabaseLabelsDataSet2.LabelsLabelCategoriesDataTable dataTable) {
        ...
        public virtual DatabaseLabelsDataSet2.LabelsLabelCategoriesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseLabelsDataSet2.LabelsLabelCategoriesDataTable dataTable = new DatabaseLabelsDataSet2.LabelsLabelCategoriesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseLabelsDataSet2.LabelsLabelCategoriesDataTable dataTable) {
...
SELECT Id, Name, Notes, Type, XSize, YSize, XStart, YStart, ProfileDefaults, FontVariable, LinesReduceable, ListboxIndex, FixedValue, FontLines, FontOrinetation, FontColour, FontName, FontSize, FontBold, FontItalic, Colour, ordering FROM LabelsLabelFields WHERE (Id = SCOPE_IDENTITY())";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(DatabaseLabelsDataSet2.LabelsLabelFieldsDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DatabaseLabelsDataSet2.LabelsLabelFieldsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseLabelsDataSet2.LabelsLabelFieldsDataTable dataTable = new DatabaseLabelsDataSet2.LabelsLabelFieldsDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseLabelsDataSet2.LabelsLabelFieldsDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
    ...
    public partial class LabelsLabelNamesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[LabelsLabelNames] ([Name], [Child], [Batch], [QuickPrint]) VAL" +
                ...
                "rint FROM LabelsLabelNames WHERE (Id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Name", global::System.Data.SqlDbType.NChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
...
SELECT Id, Name, Child, Batch, QuickPrint FROM LabelsLabelNames WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Name", global::System.Data.SqlDbType.NChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, Name, Child, Batch, QuickPrint FROM dbo.LabelsLabelNames";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(DatabaseLabelsDataSet2.LabelsLabelNamesDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DatabaseLabelsDataSet2.LabelsLabelNamesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseLabelsDataSet2.LabelsLabelNamesDataTable dataTable = new DatabaseLabelsDataSet2.LabelsLabelNamesDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseLabelsDataSet2.LabelsLabelNamesDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
...
SELECT Id, Name, OffsetDown, OffsetRight FROM Printers WHERE (Id = @Id)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(DatabaseLabelsDataSet2.PrintersDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DatabaseLabelsDataSet2.PrintersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseLabelsDataSet2.PrintersDataTable dataTable = new DatabaseLabelsDataSet2.PrintersDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseLabelsDataSet2.PrintersDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
