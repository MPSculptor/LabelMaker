...
namespace SQLBackup
{
    public class SQLBackup
    {
        ...
        {
            SQLBackup backup = new SQLBackup(args[1], args[3], args[2]);
        ...
        public static void backupUtility(string[] information)
        {
            LabelMaker.FormInformation formI = new LabelMaker.FormInformation(information);
            formI.Show();
